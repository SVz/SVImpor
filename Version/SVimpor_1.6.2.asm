...
;__________________________________________________________________________________________
                ...
                call search_fix             ; search all Call [xxxx] to fix IAT (multi IAT/thunk)
...
loop_search_call:
    ...
    mov ebx,[esp-0Ch]               ;right address here
    mov right_rva,ebx
    
    mov ecx,buffer1
    mov dword ptr [edi],ecx         ;restore original cpde
    mov ecx,buffer2
...
loop_thunk:
    ...
    mov eax,dword ptr [edi+4]
    mov buffer2,eax
    mov dword ptr [edi],0c304c483h  ;add esp,8
                                    ;ret
    call [v_add]
                
    mov ebx,[esp-08h]               ;right address here
    mov v_add,ebx
    
    mov edx,buffer1
    mov dword ptr [edi],edx         ;restore original cpde
    mov edx,buffer2
